...
-- inserting records for all tables	
	INSERT INTO tbl_publisher
		...
		('Chilton Books','Chennai, Tamil nadu , India','7896541258'),
	...
	-- this table holds publisher details (name , addredd , phonenumber)
	SELECT * FROM tbl_publisher;
	SELECT * FROM tbl_publisher WHERE publisher_PublisherName = 'George Allen & Unwin'; 
	...
	-- this table contains book name and book publisher name from tbl_publisher table
    ...
    -- tis table contains lebrary details (Branch Name and Branch Address)
	SELECT * FROM tbl_library_branch;
	...
	-- this table contains book borrower details (card no , name , address , phone number)
	SELECT * FROM tbl_borrower
 ...
 -- tbl_book(book_BookID) tbl_library_branch(library_branch_BranchID)  tbl_borrower(borrower_CardNo) 
 -- this contains loan details bookid , branch id and cardno
	SELECT * FROM tbl_book_loans;
	...
	-- this contains book id , branch id , no of copies
	SELECT * FROM tbl_book_copies
